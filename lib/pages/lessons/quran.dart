...
class QuranM extends StatefulWidget {
  @override
  _QuranMState createState() => _QuranMState();
}

class _QuranMState extends State<QuranM> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Wid().appbar('Tajweed'),
      body: StreamBuilder(
          stream: Firestore.instance.collection('quran').snapshots(),
          builder:
