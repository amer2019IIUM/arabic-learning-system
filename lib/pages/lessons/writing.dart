...
class WritingM extends StatefulWidget {
  @override
  _WritingMState createState() => _WritingMState();
}

class _WritingMState extends State<WritingM> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Wid().appbar('writing'),
      body: StreamBuilder(
          stream: Firestore.instance.collection('writing').snapshots(),
          builder:
