...
class SarfM extends StatefulWidget {
  @override
  _SarfMState createState() => _SarfMState();
}

class _SarfMState extends State<SarfM> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Wid().appbar('Sarf'),
      body: StreamBuilder(
          stream: Firestore.instance.collection('sarf').snapshots(),
          builder:
