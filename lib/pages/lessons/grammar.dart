...
class GrammarM extends StatefulWidget {
  @override
  _GrammarMState createState() => _GrammarMState();
}

class _GrammarMState extends State<GrammarM> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Wid().appbar('Grammar'),
      body: StreamBuilder(
          stream: Firestore.instance.collection('grammar').snapshots(),
          builder:
