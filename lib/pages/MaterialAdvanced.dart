...
class MaterialAdvance extends StatefulWidget {
  @override
  _MaterialAdvanceState createState() => _MaterialAdvanceState();
}

class _MaterialAdvanceState extends State<MaterialAdvance> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: Firestore.instance.collection('Advanced').snapshots(),
          builder:
